...
echo "USER1" > private/default_settlement_enforced.txt
echo "USER2" >> private/default_settlement_enforced.txt
echo "USER3" >> private/default_settlement_enforced.txt
